...
* 프로그램이 처음 켜지면 메인 메뉴(1~5번)를 띄워줍니다. 5번 운동 루틴을 조회해서 오늘 해야할 운동을 확인합니다. 이기능은 리스트 조작을 통해 언제든지 운동루틴을 유동적으로 변경할 수 있습니다. 1번 식단 기록에스는 오늘 먹은 음식의 칼로리와 몸무게를 입력해 하루 섭취 권장량에 맞춰서 먹었는 지 체크합니다 2번 메뉴는 운동 할때 종목별 횟수 와 무게를 입력 받아 총 볼륨을 산출합니다. 3번 메뉴는 본인의 아침 몸무게를 입력해 BMI수치를 계산하여 현재 본인의 체중상태를 알려줍니다. 4번 메뉴는 체계적인 삶을 살기 위해 자신이 정해둔 루틴 예를 즐어 운동, 전공공부등을 했는 지 기록합니다. 마지막으로 0번을 누르면 프로그램이 종료됩니다
